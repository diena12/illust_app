<x-admin-templete>
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg mx-10 my-5">
        <div>
            <input type="text" placeholder="追加するカテゴリー名を入力してください">
            <input type="submit" value="カテゴリーを追加" id="category_add">
        </div>
